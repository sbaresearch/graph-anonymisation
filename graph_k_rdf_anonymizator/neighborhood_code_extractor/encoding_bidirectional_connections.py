...
# URL: https://stackoverflow.com/questions/10301000/python-connected-components
...
def find_candidate_path_in_components(components):
    ...
    # EXPERIMENTATION HERE - TODO 

    for component in components:
        
        # #count size of the component
        # size_component = 0
        # for c in components[component]:
        #     for j in components[component][c]:
        #         size_component +=1
...
def compute_fnhc_bidirectional(fnhc_dict, bidirectionals):
